...
public enum CommonCode {
    ...
    UPDATED("C204", "리소스가 성공적으로 수정되었습니다.", HttpStatus.NO_CONTENT),
    DELETED("C205", "리소스가 성공적으로 삭제되었습니다.", HttpStatus.NO_CONTENT),
    ...
    USER_UPDATED("U204", "회원 정보가 수정되었습니다.", HttpStatus.NO_CONTENT),
    USER_DELETED("U205", "회원 탈퇴가 완료되었습니다.", HttpStatus.NO_CONTENT),
    ...
    POST_UPDATED("P204", "게시글이 수정되었습니다.", HttpStatus.NO_CONTENT),
    POST_DELETED("P205", "게시글이 삭제되었습니다.", HttpStatus.NO_CONTENT),
    ...
    LOGOUT_SUCCESS("A205", "로그아웃에 성공했습니다.", HttpStatus.NO_CONTENT);
